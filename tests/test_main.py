...
# Refactor Automate first and last step. 

@pytest.fixture(scope="module", autouse=True)  # When we define scope as module, All test will automatically use the function under this fixture
def get_db_session():
...
def test_create_todo(test_app):
    ...
    # client = TestClient(app=app)
    test_todo = {"content":"create a new todo test", "is_completed": False}
